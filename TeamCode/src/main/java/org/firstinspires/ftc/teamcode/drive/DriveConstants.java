...
public class DriveConstants {
    ...
    public static double TRACK_WIDTH = 16.34; // Chassis track width = 16.34, dead wheel track width = 7.5
    ...
    public static double MAX_ANG_VEL = Math.toRadians(296.23125000000005);
